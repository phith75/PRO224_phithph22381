    ...
    return (
        <div className="h-[2658px] text-center mt-[16px] bg-primary">
            <header className=" text-secondary p-4 relative bg-[url(/ticket.png/)] bg-cover w-full bg-center bg-no-repeat">
                ...
                <h1 className="text-4xl font-bold text-white mt-[200px]">
                    Đặt vé chưa bao giờ <br />
                    thật dễ dàng!
                </h1>

                <p className="text-center text-white mt-[16px]">
                    Mở khóa liền mạch thế giới phim ảnh! Hãy đặt vé xem phim CGV
                    Cinema một cách tuyệt đối <br />
                    dễ dàng thông qua trang web thân thiện với người dùng của
                    chúng tôi. Hành trình điện ảnh của bạn chỉ cách đó vài cú
                    nhấp chuột!
                </p>
                ...
                <div className="flex justify-center items-center mt-[50px]">
                    ...
                    <Link to={"#"}>
                        <div className="px-8 border-tertiary text-white border p-2 rounded-[48px] ml-4 text-gray">
                            Sách theo rạp chiếu phima
                        </div>
                    </Link>
                </div>
            </header>
            <body>
                ...
                <div className="flex justify-center items-center  mt-[15px]">
                    <div className="w-294 h-448 rounded-lg  p-4 m-4">
                        ...
                        <h2 className="text-xl font-poppins font-bold text-[31px] leading-[37.2px] text-white text-left mt-0">
                            Oppenheimer
                        </h2>
                        ...
                        <Link to={"#"}>
                            {" "}
                            <div className="w-300 h-200 bg-tertiary text-white p-2 rounded-md mt-[15px]">
                                Book by Movie
                            </div>
                        </Link>
                    </div>
                ...
                <div className="items-center mt-[50px]  bg-primary">
                    ...
                    <p className="underline text-secondary mt-[30px]">
                        Xem thêm
                    </p>
                </div>
            </body>
