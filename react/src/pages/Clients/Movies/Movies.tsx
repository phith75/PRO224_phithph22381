 ...
 const Movies = () =>{
    ...
    <div className=" container m-auto w-full">
        ...
        <div className="text-center">
            <h1 className="text-center ml-[-50px] text-3xl mb-6 text-white">Now Playing</h1>
        ...
        <div className="text-center mt-[380px]">
            <h1 className="text-center ml-[-50px] text-3xl mb-8 text-white">Upcoming</h1>
        ...
        <div className="mt-[320px] ml-[-100px]">
            <Footer></Footer>
        </div>
    </div>
</body>
