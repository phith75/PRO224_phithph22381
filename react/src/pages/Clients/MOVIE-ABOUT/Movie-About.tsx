        ...
        <div className=" text-center bg-primary">
            <section className=" text-secondary p-4 relative bg-[url(/open.png/)] bg-cover w-full bg-center bg-no-repeat">
                ...
                <p className="text-center text-white mt-[16px]">
                    ...
                    <br /> và vai trò của ông trong việc phát triển bom nguyên
                    tử.
                </p>
                ...
                <div className="flex justify-center  mt-[50px]">
                    ...
                    <Link to={"#"}>
                        <div className="  border-tertiary text-white border p-2 rounded-[48px] ml-4 text-gray">
                            Giới thiệu
                        </div>
                    </Link>
                </div>
            ...
            <body>
                <div className="items-center  mt-[200px] ">
                    ...
                    <p className="text-center text-secondary mt-[20px]">
                        Câu chuyện về nhà khoa học người Mỹ, J. Robert
                        Oppenheimer,
                        <br /> và vai trò của ông trong việc phát triển bom
                        nguyên tử.
                    </p>
                </div>
